...
public class InformationMarkerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String getAddressMarker() {
        ...
        String address = "Chưa rõ";
        if (WelcomeScreenActivity.instance.allBusStopInfomation.getAllBus().containsKey(latLng)) {
            address = WelcomeScreenActivity.instance.allBusStopInfomation.getAllBus().get(latLng).getAddress();
        }
        return address;
    }
